...
public class PlayerMovementControllerPlatformer : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Controls.PlayerSideScroller.Movement.performed += Context => direction = Context.ReadValue<float>();
        Controls.PlayerSideScroller.Movement.canceled += Context => direction = 0;
        Controls.PlayerSideScroller.Jump.performed += Context => jumpFunc();
    }
